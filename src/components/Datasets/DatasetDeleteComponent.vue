        ...
        <div class="col-12 ml-2 mr-2 pl-2 pr-2">
            ...
            <div class="row mt-3">
                <div class="col-4 offset-4">
                    ...
                    <b-form-select v-model="datasetToDelete" :options="getAvailableDatasets" class="form-control">
        ...
        deleteDataset(datasetToDelete) {
            ...
            axios.post(url_to_delete_dataset, payload).then(response => {
                ...
                switch (responseData.code) {
                    case 1:
                        this.$root.$emit("pushAlert", "Dataset deleted!")
                        break
                    case 1000:
                    case 1001:
                    case 1002:
                        this.$root.$emit("pushAlert", "Couldn't delete the dataset...")
                }
